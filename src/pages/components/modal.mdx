...
<Example>
  <div class="flex items-center gap-4 flex-wrap">
    ...
    <Button data-toggle='modal-sm'>Small</Button>
    <Button data-toggle='modal-md'>Medium</Button>
    <Button data-toggle='modal-lg'>Large</Button>
    <Button data-toggle='modal-xl'>Extra large</Button>
    <Button data-toggle='modal-2xl'>2xl</Button>
    <Button data-toggle='modal-3xl'>3xl</Button>
    <Button data-toggle='modal-4xl'>4xl</Button>
    <Button data-toggle='modal-5xl'>5xl</Button>
    <Button data-toggle='modal-6xl'>6xl</Button>
    <Button data-toggle='modal-7xl'>7xl</Button>
    <Button data-toggle='modal-8xl'>8xl</Button>
    <Button data-toggle='modal-9xl'>9xl</Button>
    <Button data-toggle='modal-full'>Full</Button>
  </div>
...
<Example>
  <Button data-toggle='modal-hide-button-close'>Example</Button>
...
<Example>
  <Button data-toggle='modal-border'>Example</Button>
