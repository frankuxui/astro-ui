...
<div class="flex items-center gap-4">
  ...
  <Button isLoading variant='dark'>Loading...</Button>
</div>
</Example>
...
| ---- | ---- | ------- | ----------- |
| variant | String | primary | Variante del botón. Las variantes disponibles son: `primary`, `secondary`, `error`, `dark` y `light`. |
