...
Para restablecer o deshacer los estilos de los botones, simplemente añade la clase `inline` al botón. Esta acción anulará las propiedades `variant` y `size` del botón, permitiendo que se adapte de manera óptima a tus necesidades y estilos altamente personalizados.
